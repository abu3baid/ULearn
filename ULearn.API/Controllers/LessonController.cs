...
namespace ULearn.API.Controllers
{
    ...
    public class LessonController : ApiBaseController
    {
        ...
        [Route("api/v{version:apiVersion}/Lesson/create")]
        [HttpPost]
        [MapToApiVersion("1")]
        [Authorize]
        ...
        [Route("api/v{version:apiVersion}/Lesson/getAll")]
        [HttpGet]
        ...
        [Route("api/v{version:apiVersion}/Lesson/get/{id}")]
        [HttpGet]
        [MapToApiVersion("1")]
        [Authorize]
        ...
        [Route("api/v{version:apiVersion}/Lesson/delete/{id}")]
        [HttpDelete]
        [MapToApiVersion("1")]
        [Authorize]
        ...
        [Route("api/v{version:apiVersion}/Lesson/update")]
        [HttpPut]
        [MapToApiVersion("1")]
        [Authorize]
