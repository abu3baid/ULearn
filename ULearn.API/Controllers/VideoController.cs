...
namespace ULearn.API.Controllers
{
    ...
    public class VideoController : ApiBaseController
    {
        ...
        [Route("api/v{version:apiVersion}/video/create")]
        [HttpPost]
        [MapToApiVersion("1")]
        [Authorize]
        ...
        [Route("api/v{version:apiVersion}/video/getAll")]
        [HttpGet]
        ...
        [Route("api/v{version:apiVersion}/video/get/{id}")]
        [HttpGet]
        [MapToApiVersion("1")]
        [Authorize]
        ...
        [Route("api/v{version:apiVersion}/video/delete/{id}")]
        [HttpDelete]
        [MapToApiVersion("1")]
        [Authorize]
        ...
        [Route("api/v{version:apiVersion}/video/update")]
        [HttpPut]
        [MapToApiVersion("1")]
        [Authorize]
